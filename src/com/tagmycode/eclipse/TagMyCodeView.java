...
public class TagMyCodeView extends ViewPart {
	 ...
	 */
	public static final String ID = "com.tagmycode.eclipse.views.TagMyCodeView";
	...
	public void createPartControl(Composite parent) {
		...
		Frame frame = SWT_AWT.new_Frame(composite);
	       ...
	       try {
	            final FrameworkConfig frameworkConfig = new FrameworkConfig(new PasswordKeyChain(), new PreferencesManager(), new MessageManager(), new TaskFactory(), frame);
